          ...
          '<div style="flex:0 0 278px;">',
            '<div style="background:#fff;border:1px solid #e5e7eb;border-radius:16px;',
              ...
              '<div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">',
                '<div style="width:40px;height:40px;border-radius:50%;background:#0F1729;',
                     'display:flex;align-items:center;justify-content:center;">',
                  '<span id="pa-total" style="color:#fff;font-size:15px;font-weight:800;">'+initialSt.total+'</span>',
                '</div>',
              '</div>',
              '<div style="height:3px;background:linear-gradient(to right,'+GOLD+',#0F1729);border-radius:2px;margin:10px 0 20px;"></div>',
